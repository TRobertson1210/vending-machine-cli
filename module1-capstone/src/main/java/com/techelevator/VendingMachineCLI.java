...
public class VendingMachineCLI {
	...
	public static void purchase(BigDecimal currentBalance) {
		System.out.println("\n(1) Feed Money");
	...
	public static void finishTransaction(List<Item> purchasedItems,BigDecimal currentBalance, BigDecimal previousBalance) {
	...
	public static void main(String[] args) {
			...
			while (machine.isItOn()) {
				...
				if (mainMenuChoice == 2) {
					purchase(machine.getCurrentBalance());
				...
				if (purchaseMenuChoice == 3) {
					finishTransaction(machine.getPurchasedItems(), machine.getCurrentBalance(), machine.getPreviousBalance());
